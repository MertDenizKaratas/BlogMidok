        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogPostImageId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogImages", x => new { x.BlogPostId, x.BlogPostImageId });
                    table.ForeignKey(
                        name: "FK_BlogImages_Files_BlogPostImageId",
                        column: x => x.BlogPostImageId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogImages_Posts_BlogPostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogImages_BlogPostImageId",
                table: "BlogImages",
                column: "BlogPostImageId");
